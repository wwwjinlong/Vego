...
public class RSACryptUtil
{
	...
	public static String sign(byte[] data, String privateKey) throws Exception {
		// 解密由base64编码的私钥
		byte[] keyBytes = Base64Coder.fromBase64String(privateKey);
		...
		return Base64Coder.toBase64String(signature.sign());
	}
	...
	public static boolean verify(byte[] data, String publicKey, String sign) throws Exception {
		// 解密由base64编码的公钥
		byte[] keyBytes = Base64Coder.fromBase64String(publicKey);
		...
		signature.update(data);
		// 验证签名是否正常
		return signature.verify(Base64Coder.fromBase64String(sign));
	}
	...
	public static byte[] decryptByPrivateKey(byte[] data, String key) throws Exception {
		// 对密钥解密
		byte[] keyBytes = Base64Coder.fromBase64String(key);
		// 取得私钥
		PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
		KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
	...
	public static String getPrivateKey(Map<String, Object> keyMap) throws Exception {
		...
		return Base64Coder.toBase64String(key.getEncoded());
	}
